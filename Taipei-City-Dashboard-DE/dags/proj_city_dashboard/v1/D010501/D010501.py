...
def _D010501(**kwargs):
    ...
    for raw_data in raw_datas:
        ...
        data["accept_time"] = convert_str_to_time_format(
            data["accept_time"], errors="coerce"
        )
    ...
    for ready_data in ready_datas:
        ...
        update_lasttime_in_data_to_dataset_info(
            engine, dag_id, data["close_time"].max()
        )


dag = CommonDag(proj_folder="proj_city_dashboard/v1", dag_folder="D010501")
dag.create_dag(etl_func=_D010501)
