...
def _D050101_3(**kwargs):
    ...
    url = f"https://opendata.cwa.gov.tw/fileapi/v1/opendataapi/O-A0001-001?Authorization={cwa_api_key}&format=json"
    GEOMETRY_TYPE = "Point"
    FROM_CRS = 4326
    ...
    # define column type
    str_columns = ["name", "id", "city", "town", "weather"]
...
dag = CommonDag(proj_folder="proj_city_dashboard/v1", dag_folder="D050101_3")
dag.create_dag(etl_func=_D050101_3)
